...
//   let gBye = '. Have a great day.';
//   return greetings + name + gBye;
...
//   const t = celsius;
//   const farenheit = t * 9/5 + 32;
// return farenheit;
// }
// console.log (temperatureCtoF(24).toFixed(0))
...
//   const t = c;
//   const temperature =  t * 9/5 + 32
// return [`${temperature}F`, f + 'F']

// }

// console.log (temperatureInF(24,88));
...
//   const instruct = ['id:' + id, 'name:' + name, 'email:' + email]
...
// ]
// function getCarInfoByIndex(data, id) {

//   console.log (data[id]);
//   console.log (Object.values(data[id]));
//   const test = Object.values(data[id])
//  console.log ("This is a " + test[1] +" "+ test[2]);
...
//   for (i = 0; i < arraylength; i++) {
//       myResults.push(data[i].car_year);
// }
// console.log (myResults);
// } 
// getModelYears()
